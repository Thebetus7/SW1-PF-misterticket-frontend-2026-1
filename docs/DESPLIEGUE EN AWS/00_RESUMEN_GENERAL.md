# Despliegue Frontend (Next.js) en AWS — Resumen General

Esta guía describe cómo empaquetar y desplegar el frontend de **MisterTicket** en AWS usando **Docker** y **Docker Compose**. Este enfoque te permitirá aislar la aplicación web de React/Next.js y exponerla en un contenedor de manera limpia y reproducible.
...
│    Dockerfile, docker-compose.yml (Next.js)                         │
│                              ↓                                      │
...
│    Clonar repo, construir imagen y levantar el contenedor           │
│                              ↓                                      │
│ 5. ACTUALIZAR (cada vez que haya cambios)                           │
│    git push → SSH → git pull → docker-compose up --build -d         │
│                              ↓                                      │
...
| `04_DESPLEGAR_Y_VERIFICAR.md` | Clonar, construir, levantar y verificar la web. |
